...
- Repository analysis (auto-collected by the stage2 Python script before your invocation):
  ...
  and recent git log (last 20 commits reachable from HEAD — in working-folder mode do not
  use `git log --all` or remote tips ahead of HEAD; see schema
  `working_folder_repo.git_history_scope`).
