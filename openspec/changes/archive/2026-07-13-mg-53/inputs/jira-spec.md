# MG-53 — Jira Ticket + Enhancement Proposal
...
|-------|-------|
| **Key** | MG-53 |
| **Summary** | As a user, I want to customize the SFTP hostname where must-gather bundles are uploaded |
| **Status** | Closed (Done) |
| **Type** | Story |
| **Assignee** | Shivprakash Muley |
| **Labels** | oap-plan |
| **URL** | https://issues.redhat.com/browse/MG-53 |

### Description

Currently the hostname is hardcoded to sftp.access.redhat.com.
Make it configurable so that in CI or local testing, we can use servers other than production like sftp.access.stage.redhat.com

### Acceptance Criteria

- Able to upload must-gather bundle to staging servers.

---

## Enhancement Proposal: Extensible Upload Targets

**Source:** `ep.md` (from [openshift/enhancements PR #1831](https://github.com/openshift/enhancements/pull/1831))  
**Title:** operator-upload-targets  
**Status:** implementable  
**Tracking:** https://issues.redhat.com/browse/MG-53
